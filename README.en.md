...
Tests export generated diagrams to `artifacts/mermaid/`. Validation uses the pinned official Mermaid parser and fails if no diagrams are present. GitHub Actions includes Python test/build jobs on Windows, Linux and macOS, plus Mermaid validation.
